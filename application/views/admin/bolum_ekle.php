...
<li class="breadcrumb-item active"> <?php echo $dizi->dizi_baslik; ?> isimli dizinin <?php echo $list->sezon_baslik; ?>una bölüm ekle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-file"></i> <?php echo $dizi->dizi_baslik; ?> isimli dizinin <?php echo $list->sezon_baslik; ?>una bölüm ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/diziler/bolum-ekle/$list->sezon_id"); ?>" method="post">
<input type="hidden" class="form-control" name="d" value="<?php echo $dizi->id; ?>">
<div class="form-group">
<label for="badi">Bölüm Adı</label>
<input type="text" class="form-control" id="badi" name="badi">
</div>
<div class="form-group">
...
<input type="text" class="form-control" id="bkodu" name="bkodu">
</div>
<div class="form-group">
...
<textarea class="form-control" id="ozet" name="ozet"></textarea>
</div>
<div class="form-group">
